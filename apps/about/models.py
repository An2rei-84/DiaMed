...
class CompanyHistory(models.Model):
    ...
    image = models.ImageField(upload_to="about/history/", blank=True, null=True, verbose_name="Изображение")
...
class TeamMember(models.Model):
    ...
    photo = models.ImageField(upload_to="about/team/", blank=True, null=True, verbose_name="Фото")
